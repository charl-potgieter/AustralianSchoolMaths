...
### Formulas
{{< tabs "tab7886a50068f4a78f" >}}

{{< tab "Standard View" >}}

<style type="text/css">
#T_NONE7886a50068f4a78f th.col_heading {
  text-align: left;
  font-size: 1em;
}
#T_NONE7886a50068f4a78f td {
  text-align: left;
  font-size: 1em;
  padding: 1.5em;
}
</style>
<table id="T_NONE7886a50068f4a78f">
  <thead>
  </thead>
  <tbody>
    <tr>
      <td id="T_NONE7886a50068f4a78f_row0_col0" class="data row0 col0" >$ {\Large\int} u \dfrac{dv}{dx} dx=uv-{\Large\int}v \dfrac {du}{dx}dx$</td>
    </tr>
  </tbody>
</table>
{{< /tab >}}
...
<style type="text/css">
#T_FORMULA_SHEET7886a50068f4a78f th.col_heading {
  text-align: left;
  font-size: 1em;
}
#T_FORMULA_SHEET7886a50068f4a78f td {
  text-align: left;
  font-size: 1em;
  padding: 1.5em;
}
#T_FORMULA_SHEET7886a50068f4a78f_row0_col0 {
  background-color: rgba(255,194,10, 0.2);
}
</style>
<table id="T_FORMULA_SHEET7886a50068f4a78f">
  <thead>
  </thead>
  <tbody>
    <tr>
      <td id="T_FORMULA_SHEET7886a50068f4a78f_row0_col0" class="data row0 col0" >$ {\Large\int} u \dfrac{dv}{dx} dx=uv-{\Large\int}v \dfrac {du}{dx}dx$</td>
    </tr>
  </tbody>
</table>
{{< /tab >}}
