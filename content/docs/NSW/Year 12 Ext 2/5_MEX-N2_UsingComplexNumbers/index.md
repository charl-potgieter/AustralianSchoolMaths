...
### Formulas
<style type="text/css">
#T_NONE3e7b69271d28ca22 th.col_heading {
  text-align: left;
  font-size: 1em;
}
#T_NONE3e7b69271d28ca22 td {
  text-align: left;
  font-size: 1em;
  padding: 1.5em;
}
</style>
<table id="T_NONE3e7b69271d28ca22">
  <thead>
  </thead>
  <tbody>
    <tr>
      <td id="T_NONE3e7b69271d28ca22_row0_col0" class="data row0 col0" >$(e ^ {i \theta})^n = e ^ {in \theta} $</td>
    </tr>
    <tr>
      <td id="T_NONE3e7b69271d28ca22_row1_col0" class="data row1 col0" >$z^n + \dfrac{1}{z^n} = 2 \cos n \theta $</td>
    </tr>
    <tr>
      <td id="T_NONE3e7b69271d28ca22_row2_col0" class="data row2 col0" >$z^n - \dfrac{1}{z^n} = 2i \sin n \theta $</td>
    </tr>
    <tr>
      <td id="T_NONE3e7b69271d28ca22_row3_col0" class="data row3 col0" >$ i = 1(\cos \dfrac{\pi}{2} + i \sin \dfrac{\pi}{2})$</td>
    </tr>
  </tbody>
</table>
