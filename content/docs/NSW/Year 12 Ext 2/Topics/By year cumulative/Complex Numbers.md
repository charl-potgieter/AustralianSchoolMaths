...
<br>
{{< tabs "2b41ef61-2370-422a-aee7-f816d2fc16ee" >}}

{{< tab "Standard view" >}}

<style type="text/css">
#T_3f9a7d5d th.col_heading {
  text-align: left;
  font-size: 1em;
}
#T_3f9a7d5d td {
...
<table id="T_3f9a7d5d">
  ...
  <tbody>
    <tr>
      <td id="T_3f9a7d5d_row0_col0" class="data row0 col0" >$ i = \sqrt{-1}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row1_col0" class="data row1 col0" >$ z = a + ib$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row2_col0" class="data row2 col0" >$\text{ mod z} =|z| = \sqrt{a^2+b^2} $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row3_col0" class="data row3 col0" >$\tan \theta = \dfrac{b}{a} \text{ where } \theta \text{ equals arg z in interval } (-\pi, \pi]  \text{Don’t confuse with angle of a position vector which ranges from 0 to 360 degrees}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row4_col0" class="data row4 col0" >$z = r (\cos \theta + i \sin \theta)$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row5_col0" class="data row5 col0" >$ z_1z_2  = r_1 r_2[\cos(\theta_1 + \theta_2) + i \sin(\theta_1 + \theta_2)]$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row6_col0" class="data row6 col0" >$ \dfrac{z_1}{z_2}  = \dfrac{r_1}{ r_2}[\cos(\theta_1 - \theta_2) + i \sin(\theta_1 - \theta_2)], z_2 \ne 0$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row7_col0" class="data row7 col0" > $ z^n = r^n(\cos n \theta + i \sin n \theta)$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row8_col0" class="data row8 col0" >$ z^{-1} = r^{-1}(\cos \theta - i \sin \theta), z \ne 0$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row9_col0" class="data row9 col0" > $ z^{-n} = r^{-n}(\cos -n \theta + i \sin -n \theta), z \ne 0, n \in \mathbb{Z}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row10_col0" class="data row10 col0" >$ z_1z_2...z_n = r_1r_2...r_n[\cos(\theta_1+\theta_2+...\theta_n) + i\sin(\theta_1+\theta_2+...\theta_n)]$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row11_col0" class="data row11 col0" >$ |z_1||z_2| = |z_1z_2| \text{ and arg } z_1z_2 = { arg } z_1 + { arg } z_2$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row12_col0" class="data row12 col0" >$ \dfrac{|z_1|}{|z_2|} = \bigg| \dfrac{z_1}{z_2} \bigg| \text{ and arg } \dfrac{z_1}{z_2} = { arg } z_1 - { arg } z_2$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row13_col0" class="data row13 col0" >$ |z|^n = |z^n| \text{ and arg } z^n = n \times \text{arg z for } n \in \mathbb{Z}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row14_col0" class="data row14 col0" >$ |z^{-1}| = \dfrac{1}{|z|} \text { and arg } z^{-1} = -\text {arg z}, z\ne 0$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row15_col0" class="data row15 col0" >$ |z^{-n}| = \dfrac{1}{|z|^n} \text { and arg } z^{-n} = \text {-n arg z}, z\ne 0 \text { for } n \in \mathbb{Z}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row16_col0" class="data row16 col0" >$ |z_1||z_2||z_3|...|z_n| = |z_1z_2z_3...z_n| \text { and arg } z_1z_2z_3...z_n = { arg } z_1 + { arg } z_2 + ...+ { arg } z_n \text { where } n \in \mathbb{Z}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row17_col0" class="data row17 col0" >$ \text{ If } z = \cos \theta + i\sin \theta \text{, then } z^{-1} = \overline{z} \text{ (only applies when modulus = 1)} $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row18_col0" class="data row18 col0" >$ z\overline{z} = |z|^2 \text{ and arg } z\overline{z} = 0  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row19_col0" class="data row19 col0" >$ |\overline{z}| = |z| \text{ and arg } \overline{z} = -{arg } z $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row20_col0" class="data row20 col0" >$ \overline{z_1} + \overline{z_2} = \overline{z_1 + z_2}  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row21_col0" class="data row21 col0" >$ \overline{z_1} \,\, \overline{z_2} = \overline{z_1 z_2}  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row22_col0" class="data row22 col0" >$ z + \overline{z} = 2Re(z)  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row23_col0" class="data row23 col0" >$ z - \overline{z} = 2Im(z)  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row24_col0" class="data row24 col0" >$ {|z+w| \le |z| + |w|} \text{ (the triangle inequality where z and w are complex numbers)}  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row25_col0" class="data row25 col0" >$ e^{i\theta} = \cos \theta + i \sin \theta, \text{ where  }\theta \in \mathbb{R}  \text{ (This is Euler's formula and represents the exponential form of a complex number)}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row26_col0" class="data row26 col0" >$ e^{i\pi} = -1  $</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row27_col0" class="data row27 col0" >$ z = a+ib = r(\cos \theta + i \sin \theta) = re^{i \theta}$</td>
    </tr>
    <tr>
      <td id="T_3f9a7d5d_row28_col0" class="data row28 col0" >$ [r(\cos \theta + i \sin \theta)]^n = r^n(\cos n\theta + i\sin n\theta) =  r^ne^{in \theta}$</td>
    </tr>
  </tbody>
</table>
{{< /tab >}}
...
#T_3f9a7d5d_row0_col0, #T_3f9a7d5d_row1_col0, #T_3f9a7d5d_row2_col0, #T_3f9a7d5d_row3_col0, #T_3f9a7d5d_row4_col0, #T_3f9a7d5d_row5_col0, #T_3f9a7d5d_row6_col0, #T_3f9a7d5d_row7_col0, #T_3f9a7d5d_row8_col0, #T_3f9a7d5d_row9_col0, #T_3f9a7d5d_row10_col0, #T_3f9a7d5d_row11_col0, #T_3f9a7d5d_row12_col0, #T_3f9a7d5d_row13_col0, #T_3f9a7d5d_row14_col0, #T_3f9a7d5d_row15_col0, #T_3f9a7d5d_row16_col0, #T_3f9a7d5d_row17_col0, #T_3f9a7d5d_row18_col0, #T_3f9a7d5d_row19_col0, #T_3f9a7d5d_row20_col0, #T_3f9a7d5d_row21_col0, #T_3f9a7d5d_row22_col0, #T_3f9a7d5d_row23_col0, #T_3f9a7d5d_row24_col0, #T_3f9a7d5d_row25_col0, #T_3f9a7d5d_row26_col0 {
  background-color: rgba(0,0,0,0);
}
#T_3f9a7d5d_row27_col0, #T_3f9a7d5d_row28_col0 {
...
#T_3f9a7d5d_row0_col0, #T_3f9a7d5d_row1_col0, #T_3f9a7d5d_row2_col0, #T_3f9a7d5d_row3_col0, #T_3f9a7d5d_row25_col0, #T_3f9a7d5d_row26_col0, #T_3f9a7d5d_row27_col0, #T_3f9a7d5d_row28_col0 {
  background-color: rgba(0,0,0,0);
}
#T_3f9a7d5d_row4_col0, #T_3f9a7d5d_row5_col0, #T_3f9a7d5d_row6_col0, #T_3f9a7d5d_row7_col0, #T_3f9a7d5d_row8_col0, #T_3f9a7d5d_row9_col0, #T_3f9a7d5d_row10_col0, #T_3f9a7d5d_row11_col0, #T_3f9a7d5d_row12_col0, #T_3f9a7d5d_row13_col0, #T_3f9a7d5d_row14_col0, #T_3f9a7d5d_row15_col0, #T_3f9a7d5d_row16_col0, #T_3f9a7d5d_row17_col0, #T_3f9a7d5d_row18_col0, #T_3f9a7d5d_row19_col0, #T_3f9a7d5d_row20_col0, #T_3f9a7d5d_row21_col0, #T_3f9a7d5d_row22_col0, #T_3f9a7d5d_row23_col0, #T_3f9a7d5d_row24_col0 {
...
<table id="T_616211d8">
  ...
  <tbody>
    <tr>
      <td id="T_616211d8_row0_col0" class="data row0 col0" >$(e ^ {i \theta})^n = e ^ {in \theta} $</td>
    </tr>
    <tr>
      <td id="T_616211d8_row1_col0" class="data row1 col0" >$z^n + \dfrac{1}{z^n} = 2 \cos n \theta $</td>
    </tr>
    <tr>
      <td id="T_616211d8_row2_col0" class="data row2 col0" >$z^n - \dfrac{1}{z^n} = 2i \sin n \theta $</td>
    </tr>
    <tr>
      <td id="T_616211d8_row3_col0" class="data row3 col0" >$ i = 1(\cos \dfrac{\pi}{2} + i \sin \dfrac{\pi}{2})$</td>
    </tr>
  </tbody>
</table>
